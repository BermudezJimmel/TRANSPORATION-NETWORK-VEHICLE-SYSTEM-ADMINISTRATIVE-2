 ...
 */
public class complaintscostumertoemp extends javax.swing.JPanel {
Connection conn = null;
ResultSet rs = null;
PreparedStatement pst = null; 
    /**
     * Creates new form complaintscostumer
     */
    public complaintscostumertoemp() {
        initComponents();
...
private void Customer(){
        ...
        try{
           ...
           String sql = "select CMCustomerID as ID,concat(CMLastname,', ',CMFirstname,' ',CMMiddlename) as Name,CMEmail as Email from Core1CMRegistration";
...
private void Employee(){
        ...
        try{
           ...
           String sql = "select CHCEMP_ID as ID,concat(Lastname,', ',Firstname,' ',MI) as Name from HR4CHCEmployee_Record";
           pst=conn.prepareStatement(sql);
...
//}
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1180, 540));
        ...
        jLabel22.setText("cust to emp");
        jPanel3.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 190, 170, 20));

        jPanel6.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 610, 520));
        ...
        jPanel1.add(type, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 170, 170, 60));
        ...
        jPanel6.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 0, 610, 520));

        add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1220, 520));
